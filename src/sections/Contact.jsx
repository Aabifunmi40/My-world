...
const SERVICE_ID  = "service_dgqx5dc";
const TEMPLATE_ID = "template_dv8djm6";
...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute rounded-full opacity-[0.08]"
        style={{ width: 460, height: 460, background: "#C8960C", filter: "blur(100px)", top: -60, left: "50%", transform: "translateX(-50%)" }}
      />
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input name="email" type="email" value={form.email} onChange={handleChange} required placeholder="your@email.com" className="contact-input" />
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea name="message" value={form.message} onChange={handleChange} required rows={6}
                    placeholder="Tell me about your project or what you need help with..." className="contact-input resize-none" />
                </div>
